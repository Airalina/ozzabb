<div id="create">
    @if ($funcion == 'neworder')
        <div>
            <button wire:click="volverexplora()" type="button" class="btn btn-danger"><i class="fas fa-arrow-left"></i>
                Volver</button>
        </div>
        <br>
    @endif
    @switch($funcion)
        ...
        @case('neworder')
            <livewire:ordenesclientes view="create" component="clientes" :customersData="$customersData" :customer="$customer" />
        @break
