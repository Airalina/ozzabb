                            ...
                            <div class="card-header">
                                @if ($addMaterial)
                                    <div class="form-group">
                                        <button wire:click="selMaterial()" type="button"
                                            class="btn btn-danger btn-sm">Volver a seleccionar material</button>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name_material"
                                            wire:model="name_material" placeholder="Nombre del material" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="family">Familia</label>
                                        <select class="form-control form-control-sm" wire:model="family"
                                            wire:change="con" id="family">
                                    ...
                                    <x-material-card :div="$div" :info_term="$info_term" :info_sell="$info_sell"
                                        :info_con="$info_con" :material_family="$material_family" :rplce=null
                                        :terminal_id=null :seal_id=null :connector_id=null />
                                ...
                                @else
                                    <div class="form-group">
                                        <button wire:click="addMaterial()" type="button"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="string" id="amount"
                                    wire:model.defer="amount" placeholder="Ingrese la cantidad">
                            </div>
                            <div class="form-group">
                                <label for="unit">Unidad de presentación</label>
                                <div class="d-flex">
                                    <input class="form-control form-control-sm" type="string" id="unit"
                                        wire:model.defer="unit" placeholder="Ingrese las unidades">
                                    <select class="form-control form-control-sm" wire:model.defer="presentation"
                                        id="presentation">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-sm" type="text" id="usd_price"
                                    wire:model.defer="usd_price" placeholder="Ingrese el precio U$D">
                            </div>
                            <div class="form-group">
                                <label for="ars_price">Precio AR$</label>
                                <input class="form-control form-control-sm" type="text" id="ars_price"
                                    wire:model.defer="ars_price" placeholder="Ingrese el precio AR$">
                            </div>
                            <div class="modal-footer">
                                ...
                                @else
                                    <button wire:click.prevent="editarmat()" type="submit"
