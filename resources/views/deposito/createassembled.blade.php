                ...
                @endif
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-sm" rows="3" wire:model="description" style="width: 300px" placeholder="Descripción ..."></textarea>
                        </div>
                        <div class="form-group">
                          ...
                          <table class="table table-hover table-sm">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td style="text-align: center"><button type="button"  wire:click="downmateriall({{ $detail[3] }})" class="btn btn-danger btn-sm">Quitar</button></td>
                              </tr>
                              @endforeach
                            </tbody>
                          </table>
