...
class Instalaciones extends Component
{
    ...
    public $details=array(), $detail=array(), $nombrefile, $seeimg=false, $detailslist, $order="code", $photo=null, $count=0, $reason, $date, $amount, $newdetail, $number_version, $material_id, $detail_id, $upca=false;
